...
function MyApp({ Component, pageProps }) {
  ...
  useEffect(() => {
    const start = (url) => {
      ...
      const isPublicRoute =
        router.pathname.startsWith("/public") || router.pathname === "/[msp]";
      const isPublicToSignupRoute = isPublicRoute && url === "/public/signup";
      const isSignupToPublicRoute =
        router.pathname === "/public/signup" && url === "/public";
      ...
      if (
        ...
        !isPublicToSignupRoute &&
        !isSignupToPublicRoute
      ) {
        if (

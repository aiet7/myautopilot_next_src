...
const Nable = () => {
  ...
  const { activeIntegrationsCard, handleIntegrationsCard } =
          ...
          <div className="w-full border">
            <div className="flex flex-col">
              <div className="flex flex-col p-4 border-b h-28">
                <p className="text-xl">
                  Nable{" "}
                  {activeIntegrationsCard === "nablermm" ? "RMM" : "Central"}{" "}
              ...
              <div className="flex flex-col p-4 gap-6 text-sm">
                ...
                <div className="flex flex-col gap-6 lg:flex-row">
                  <div className="flex flex-col w-full gap-1">
                    <p>API Key</p>
                    <p className="dark:text-white/60 text-black/60">
                      Your generated API Key that was created via Nable{" "}
                      {activeIntegrationsCard === "nablermm"
                        ? "RMM"
                        : "Central"}{" "}
                      API
